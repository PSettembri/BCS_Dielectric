...
!     on the number of implied subscripts.
!     the subroutine is called once foreach variate.
...
!     error finish, insufficient array storage
  998 isn=0
      write(*,*) "array bounds exceeded within subroutine cft"
      stop
      end
